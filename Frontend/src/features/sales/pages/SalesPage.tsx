...
export default function Sales() {
 ...
 <motion.div {...fadeUp(0.25)} className="brand-card border rounded-2xl overflow-hidden" style={{ background: 'var(--brand-surface-gradient)', borderColor: 'var(--brand-border)' }}>
