...
export default function Users() {
 ...
 <div className="brand-card border rounded-3xl overflow-hidden shadow-xl mb-6" style={{ background: 'var(--brand-surface-gradient)', borderColor: 'var(--brand-border)' }}>
 ...
 <div className="brand-card border rounded-2xl p-5 mb-6" style={{ background: 'var(--brand-surface-gradient)', borderColor: 'var(--brand-border)' }}>
 ...
 {tab === 'requests' && (
 <div className="bg-card shadow-soft dark:shadow-none dark:bg-muted/50 border border-border shadow-[0_1px_2px_rgba(0,0,0,0.03)] rounded-2xl overflow-hidden">
