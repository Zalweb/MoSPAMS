...
export default function ApprovalsPage() {
 ...
 <div className="bg-card shadow-soft dark:shadow-none dark:bg-zinc-900/40 border border-border rounded-2xl shadow-[0_1px_2px_rgba(0,0,0,0.03)] overflow-hidden">
 {loading ? (
