...
export default function DashboardLayout() {
 ...
 {/* Top header */}
 <div className="sticky top-0 z-30 bg-background/80 border-b border-border/50">
 ...
 className="absolute right-0 top-full mt-2 w-[320px] bg-muted/95 rounded-2xl border border-border shadow-2xl z-50 overflow-hidden"
 >
 ...
 animate={{ opacity: 1, y: 0, scale: 1 }}
 exit={{ opacity: 0, y: -10, scale: 0.95 }}
 className="absolute right-0 top-full mt-2 w-[220px] bg-muted/95 rounded-2xl border border-border shadow-2xl z-50 overflow-hidden"
 >
 ...
 <nav 
 className="pointer-events-auto flex items-center p-1.5 rounded-[28px] border border-border/50 shadow-[0_8px_32px_rgba(0,0,0,0.12)] overflow-x-auto no-scrollbar max-w-full"
 style={{
