...
const CARD = "relative group flex flex-col h-full brand-card border rounded-2xl overflow-hidden transition-all duration-300";
...
export default function DashboardPage() {
 ...
 <motion.div
 {...fadeUp(0.45)}
 className="brand-card border rounded-2xl overflow-hidden"
 style={CARD_STYLE}
 >
