...
export default function BookService() {
 ...
 <motion.div
 {...fadeUp(0.1)}
 className="brand-card rounded-[32px] border shadow-xl p-8"
 ...
 className="absolute left-0 right-0 top-full mt-2 bg-card dark:bg-zinc-900/90 rounded-2xl border border-border shadow-2xl z-[70] overflow-hidden p-1.5"
 >
 {loadingTypes ? (
