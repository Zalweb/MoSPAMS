...
export default function CustomerManagementPage({ hideAddButton = false }: { hideAddButton?: boolean }) {
 ...
 key={stat.label}
 {...fadeUp(0.1 + i * 0.05)}
 className="bg-card dark:bg-zinc-900/50 border border-border/50 rounded-2xl p-5 shadow-sm"
 >
 ...
 <motion.div 
 {...fadeUp(0.4)}
 className="bg-card dark:bg-zinc-900/40 border border-border/50 rounded-3xl overflow-hidden shadow-xl"
 >
 ...
 <DialogContent className="sm:max-w-md rounded-[32px] border-border/50 bg-card dark:bg-zinc-950 p-0 overflow-hidden shadow-2xl">
