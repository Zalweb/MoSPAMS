...
export default function PartsCatalog() {
 ...
 className="group relative flex flex-col brand-card rounded-3xl border overflow-hidden hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300 cursor-pointer"
 ...
 <div className="absolute top-2 left-2 px-2 py-0.5 bg-background/80 rounded-full border border-border/50">
 ...
 <div className={`absolute top-4 left-4 flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider border ${selected.stock > 0 ? 'bg-green-500/10 text-green-400 border-green-500/20' : 'bg-red-500/10 text-red-400 border-red-500/20'}`}>
 {selected.stock > 0
