...
export default function Payments() {
 ...
 <motion.div
 {...fadeUp(0.1)}
 className="brand-card rounded-[32px] border shadow-xl p-8 mb-8"
 ...
 className="w-full text-left brand-card rounded-2xl border shadow-sm p-5 hover:scale-[1.01] active:scale-[0.99] transition-all duration-300 group"
 style={{ background: 'var(--brand-surface-gradient)', borderColor: 'var(--brand-border)' }}
 >
