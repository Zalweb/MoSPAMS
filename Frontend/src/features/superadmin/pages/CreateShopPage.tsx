      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <div className="bg-muted rounded-xl border border-border p-6 mb-6 text-left">
            <h3 className="text-sm font-semibold text-muted-foreground mb-4">Owner Login Credentials</h3>
            
            <div className="space-y-3">
              <div>
                <label className="text-xs text-muted-foreground block mb-1">Shop Domain</label>
              ...
              <div>
                <label className="text-xs text-muted-foreground block mb-1">Shop ID</label>
                <div className="flex items-center gap-2">
                  <input
                    type="text"
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl sm:text-[28px] font-bold text-foreground tracking-tight">Create New Shop</h1>
          <p className="text-[13px] sm:text-[14px] text-muted-foreground mt-1">Manually create a new shop and owner account</p>
        </div>
      </div>
