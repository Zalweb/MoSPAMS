...
export default function SuperAdminLayout() {
 ...
 className="absolute right-0 top-full mt-2 w-[320px] bg-card rounded-3xl border border-border shadow-2xl z-50 overflow-hidden"
 >
 ...
 initial={{ opacity: 0, y: 10, scale: 0.95 }}
 animate={{ opacity: 1, y: 0, scale: 1 }}
 className="absolute right-0 top-full mt-2 w-[240px] bg-card rounded-3xl border border-border shadow-2xl z-50 p-2"
 >
 ...
 className="lg:hidden fixed inset-0 z-40 bg-background/20 " 
