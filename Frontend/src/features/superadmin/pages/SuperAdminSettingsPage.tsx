...
export default function SuperAdminSettingsPage() {
  ...
  return (
    <div>
      <div className="mb-7">
        <h2 className="text-[22px] font-bold text-white tracking-tight">Platform Settings</h2>
        <p className="text-[13px] text-zinc-400 mt-0.5">Manage maintenance mode, API keys, and system configuration</p>
      </div>

      {loading || !settings || !health ? (
        <p className="text-[13px] text-zinc-400">Loading platform settings...</p>
      ) : (
        <div className="grid grid-cols-1 xl:grid-cols-[1.4fr,1fr] gap-4">
          <section className="bg-zinc-950 rounded-2xl border border-zinc-800 p-5">
            ...
            <label className="flex items-center justify-between mb-4">
              ...
              <input
                ...
                className="w-4 h-4 accent-white border-zinc-700 bg-zinc-900"
              />
            </label>
            ...
            <div className="space-y-3">
              <label className="block">
                ...
                <Input
                  ...
                  className="mt-1.5 h-9 rounded-xl border-zinc-700 bg-zinc-900 text-zinc-200 placeholder:text-zinc-500"
                />
              </label>
          ...
          <section className="space-y-4">
            <div className="bg-zinc-950 rounded-2xl border border-zinc-800 p-5">
              ...
              <p className="text-[11px] text-zinc-400 mt-1">{health.database.message}</p>
            </div>
            ...
            <div className="bg-zinc-950 rounded-2xl border border-zinc-800 p-5">
              ...
              <p className="text-[11px] text-zinc-400 mt-1">Generated {new Date(health.generatedAt).toLocaleString()}</p>
            </div>
          </section>
        </div>
      )}
