...
export default function PricingSection() {
 ...
 className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-muted/50 border border-border/50 text-zinc-300 text-sm font-medium mb-6"
 >
 ...
 className="relative group rounded-3xl p-8 flex flex-col transition-all duration-300 bg-muted/40 border border-border/50 hover:border-zinc-700/50 "
 >
 ...
 className="relative group rounded-3xl p-8 flex flex-col transition-all duration-300 bg-gradient-to-b from-zinc-800/80 to-zinc-900/80 border-2 border-zinc-700/50 shadow-2xl scale-105 "
 >
