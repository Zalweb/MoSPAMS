...
export default function HeroSection() {
 ...
 className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-muted/50 border border-border/50 text-zinc-300 text-sm font-medium mb-8"
 >
 ...
 className="px-8 py-4 rounded-2xl bg-muted/50 border border-border/50 text-foreground font-semibold text-base hover:bg-zinc-800/50 transition-all duration-200"
 >
 View features
 </button>
 </motion.div>
 ...
 >
 <div className="relative bg-muted/40 rounded-3xl border border-border/50 shadow-2xl p-8 overflow-hidden">
 ...
 <div className="absolute -top-4 -right-4 bg-muted/80 rounded-2xl border border-border/50 shadow-xl px-4 py-3 flex items-center gap-2">
...
function StatCard({ label, value, trend }: { label: string; value: string; trend: string }) {
 ...
 return (
 <div className="bg-zinc-800/30 rounded-2xl border border-zinc-700/30 p-4 hover:bg-zinc-800/40 transition-all">
