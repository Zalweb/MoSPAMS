        ...
        <div className="bg-muted/40 backdrop-blur-2xl rounded-3xl border border-border/50 shadow-2xl p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-6 py-3.5 rounded-xl bg-[rgb(var(--color-primary-rgb))] text-white font-semibold text-sm hover:opacity-90 transition-all shadow-lg shadow-[rgb(var(--color-primary-rgb))]/20 flex items-center justify-center gap-2 mt-2"
            >
              {loading ? (
                <>
