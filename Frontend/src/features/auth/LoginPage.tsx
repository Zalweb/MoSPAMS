...
export default function LoginPage() {
 ...
 <div className="bg-zinc-900/40 rounded-[32px] border border-white/5 shadow-2xl p-8 sm:p-10">
 ...
 <span className="px-3 bg-transparent text-zinc-500 text-[10px] uppercase tracking-widest ">or</span>
 </div>
 </div>
