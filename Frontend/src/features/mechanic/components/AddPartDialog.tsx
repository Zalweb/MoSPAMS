        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-zinc-800 border border-zinc-700 rounded-xl text-sm text-foreground placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-600"
              />
            </div>
          </div>
          ...
          <div>
            ...
            {loading ? (
              ...
              <div className="text-center py-8 bg-zinc-800/50 rounded-xl border border-border">
            ...
            <>
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-zinc-800 border border-zinc-700 rounded-xl text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-zinc-600"
                />
