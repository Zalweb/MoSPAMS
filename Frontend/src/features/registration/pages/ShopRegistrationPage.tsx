...
export default function ShopRegistrationPage() {
 ...
 <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-muted/50 border border-border/50 text-zinc-300 text-sm font-medium mb-6">
 ...
 <div className="bg-muted/40 rounded-3xl border border-border/50 p-8">
