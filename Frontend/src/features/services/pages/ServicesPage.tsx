...
export default function Services() {
 ...
 return (
 <div key={service.id} className="brand-card border rounded-2xl p-5 transition-all duration-300 group" style={{ background: 'var(--brand-surface-gradient)', borderColor: 'var(--brand-border)' }}>
 ...
 <div className="text-center py-16 text-sm text-muted-foreground brand-card border rounded-2xl" style={{ background: 'var(--brand-surface-gradient)', borderColor: 'var(--brand-border)' }}>
 ...
 {historyCustomer && (
 <>
 <div className="fixed inset-0 bg-background/60 z-40" onClick={() => setHistoryCustomer(null)} />
