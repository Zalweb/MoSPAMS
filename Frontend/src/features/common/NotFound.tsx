...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
      ...
      <Link to="/" className="mt-4 inline-flex items-center gap-1.5 px-4 h-9 rounded-xl bg-[#1C1917] text-foreground text-[12px] font-medium hover:bg-[#292524]">Back to Dashboard</Link>
    </div>
  );
}
