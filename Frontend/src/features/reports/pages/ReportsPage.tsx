...
export default function Reports() {
 ...
 <div className="p-5 brand-card border rounded-2xl" style={{ background: 'var(--brand-surface-gradient)', borderColor: 'var(--brand-border)' }}>
 ...
 <div className="brand-card border rounded-2xl p-5" style={{ background: 'var(--brand-surface-gradient)', borderColor: 'var(--brand-border)' }}>
