...
Route::middleware('service.token')->prefix('internal')->group(function () {
    ...
    Route::post('/db',                                [InternalChatController::class, 'dbOperation']);
    Route::get('/customers/count',                    [InternalChatController::class, 'customerCount']);
    Route::get('/customers',                          [InternalChatController::class, 'customerList']);
    Route::get('/customer/search',                    [InternalChatController::class, 'customerSearch']);
    Route::get('/mechanics',                          [InternalChatController::class, 'mechanicList']);
    Route::get('/user/{userId}/profile',              [InternalChatController::class, 'userProfile']);
    Route::get('/mechanic/{userId}/jobs',             [InternalChatController::class, 'mechanicJobs']);
    Route::get('/customer/{userId}/profile',          [InternalChatController::class, 'customerProfile']);
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::middleware(['shop.active', 'tenant.user', 'tenant.token'])->group(function () {
        ...
        Route::post('/inventory/barcode/link', [MospamsController::class, 'linkBarcode'])->name('barcode.link')->middleware('role:Owner,Staff');
        Route::post('/inventory/parts/with-barcode', [MospamsController::class, 'storePartWithBarcode'])->name('part.storeWithBarcode')->middleware('role:Owner,Staff');
        Route::get('/inventory/parts/{part}/barcodes', [MospamsController::class, 'getPartBarcodes'])->name('part.barcodes')->middleware('role:Owner,Staff');
